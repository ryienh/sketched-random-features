...
class AddFeaturesTransform:
    ...
    def add_features(self, data):
        ...
        for i in range(self.k):
            ...
            rbf_sketch = S_i_scaled @ Z_rbf
            rbf_parts.append(rbf_sketch)

            # Laplace features for chunk i
        ...
        # Store a no-sketch Laplace for ablations
...
if __name__ == "__main__":
    ...
    # Example usage
    transform = AddFeaturesTransform(D_out=16, k=2, alpha=0.8, beta=0.6, max_size=5000)
    ...
    print("rbf_feats shape:", sample.rbf_feats.shape)
    print("linear_feats shape:", sample.linear_feats.shape)
